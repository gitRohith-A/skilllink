         ...
         flex items-center  h-screen">
            <div className="container ">
                <div className="columns-2">
                    <div className="mb-10 text-center md:mb-16 relative">
                        ...
                        <a href="/#" className="mx-auto inline-block max-w-[160px]">
                            ...
                            <h5 className="text-4xl font-bold text-white ">SkillLink</h5>
                        </a>
                    </div>
                            ...
                            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-3xl bg-white  px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
                                ...
                                <form onSubmit={handleClick}>
                                    ...
                                    <div className="mb-5">
                                        <button
                                            type="submit"
                                            className="w-full cursor-pointer rounded-xl border border-primary bg-primary px-5 py-3 text-base font-medium text-blue-700 transition hover:bg-opacity-90 hover:bg-blue-700 hover:delay-50  hover:text-white hover:ease-in-out duration-300 disabled:bg-slate-300 disabled:text-white"
                                            disabled={isPending}
                                        >
                                            Log In
                                        </button>
