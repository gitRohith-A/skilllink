      ...
      <div className="bg-white rounded-lg shadow-xl pb-8">
        ...
        <div className="w-full h-[250px]">
          ...
          {/* <div className="bg-gray-200 relative bottom-11 left-2 w-fit p-3 rounded-full">
            <MdEdit size={15} className='text-orange-600 cursor-pointer' onClick={e => dispatch(setModal({ id: 4, type: 'edit', active: true }))} />
          </div> */}
        </div>
        {/* Profile backgorund preview and edit */}
        ...
        <div className="flex flex-col items-center -mt-20">
          ...
          <div className="bg-blue-200 relative bottom-11 left-[60px] w-fit p-3 rounded-full">
            <MdEdit size={15} className='text-orange-600 cursor-pointer' onClick={e => dispatch(setModal({ id: 3, type: 'edit', active: true }))} />
          </div>
          {/* Profile Photo preview and edit */}
